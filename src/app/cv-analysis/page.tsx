        ...
        <div className="w-full max-w-6xl">
          ...
          {!analysisResult ? (
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2"
                      >
                        {isAnalyzing ? (
                          <>
              ...
              <div className="bg-white border border-gray-200 p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">CV Score & Analysis</h3>
                      <p className="text-gray-600">Get an overall score and detailed breakdown of your CV's effectiveness for UK employers.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Ensure your CV passes Applicant Tracking Systems used by UK companies.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Get rewritten sections with improved impact and UK market alignment.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">Optimized CV Download</h3>
                      <p className="text-gray-600">Download your improved CV ready for UK job applications.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              {/* Score Header */}
              <div className="bg-white border border-gray-200 p-8 rounded-2xl shadow-lg text-center">
                <div className="inline-flex items-center gap-4 mb-4">
                  ...
                  <div className="text-left">
                    <h2 className="text-3xl font-bold text-gray-900">CV Analysis Complete!</h2>
                    <p className="text-gray-600">Your CV has good potential with room for improvement</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 justify-center">
                  <button
                    ...
                    className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105 flex items-center gap-2"
                  >
              ...
              <div className="bg-white border border-gray-200 p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-6">
                  {/* Personal Statement */}
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">✨ Improved Personal Statement</h4>
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <p className="text-gray-700 leading-relaxed">{analysisResult.optimizedSections.personalStatement}</p>
                    </div>
                  </div>

                  {/* Experience */}
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">💼 Enhanced Experience Bullets</h4>
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <ul className="space-y-2">
                  ...
                  {/* Skills */}
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-3">🎯 Optimized Skills Section</h4>
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
